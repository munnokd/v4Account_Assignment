...
const Signup = () => {
    ...
    return (
        <div className='flex justify-center items-center w-full h-[100%]'>
            <div className='w-[30%]'>
                <h1 className='text-[30px] font-medium mt-[50px]'>Signup Page</h1>
                        ...
                        {({ open }) => (
                            <>
                                <div className="relative flex mt-2">
                                    ...
                                    <div className='w-[35%] ml-[20px]'>
                                        <Link to='/add-role' className='flex w-[100%] justify-center rounded-md bg-gray-800 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-gray-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-900' >Add Role</Link>
                                    </div>
